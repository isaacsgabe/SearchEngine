...
public class DocumentStoreImplTest {
    ...
    private DocumentStore getStoreWithTextAdded() throws Exception {
    ...
    private DocumentStore getStoreWithBinaryAdded() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
    ...
    @Test
    public void stage5PushToDiskViaMaxDocCount() throws Exception {
        DocumentStoreImpl store = new DocumentStoreImpl(this.baseDir);
        store.setMaxDocumentCount(2);
        pushAboveMaxViaPutNew(store);
    }

    private void pushAboveMaxViaPutNew(DocumentStoreImpl store) throws Exception{
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
    ...
    @Test
    public void stage5PushToDiskViaMaxDocCountBringBackInViaDeleteAndSearch() throws Exception {
        DocumentStoreImpl store = new DocumentStoreImpl(this.baseDir);
        store.setMaxDocumentCount(2);
     ...
     * @throws Exception
     */
    private void deleteDocInMemoryBringInDocFromDisk(DocumentStoreImpl store) throws Exception{
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        Document doc1 = store.getDocument(this.uri1);
        Document doc2 = store.getDocument(this.uri2);
    ...
    @Test
    public void stage5PushToDiskViaMaxDocCountViaUndoDelete() throws Exception {
        DocumentStoreImpl store = new DocumentStoreImpl(this.baseDir);
        store.setMaxDocumentCount(2);
        overLimitViaUndo(store);
    }

    private void overLimitViaUndo(DocumentStoreImpl store) throws Exception {
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.TXT);
        Document doc1 = store.getDocument(this.uri1);
        Document doc2 = store.getDocument(this.uri2);
...
or returned in any form as the result of any “get” or “search” request, or an action on it is undone via any call to either of the DocumentStore.undo methods.
    ...
    @Test
    public void stage4testSetDocLastUseTimeOnGet() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
    ...
    @Test
    public void stage4testSetDocLastUseTimeOnPut() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
    ...
    @Test
    public void stage4testUpdateDocLastUseTimeOnOverwrite() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        //was last use time updated on the put?
        long before = System.nanoTime();
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()), this.uri1, DocumentStore.DocumentFormat.BINARY);
    ...
    @Test
    public void stage4testUpdateDocLastUseTimeOnSearch() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()), this.uri1, DocumentStore.DocumentFormat.TXT);
        long before = System.nanoTime();
    ...
    @Test
    public void stage4testUpdateDocLastUseTimeOnSearchByPrefix() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()), this.uri1, DocumentStore.DocumentFormat.TXT);
        long before = System.nanoTime();
        //this search should return the contents of the doc at uri1
    ...
    @Test
    public void stage3Search() throws Exception {
    ...
    @Test
    public void stage3SearchBinary() throws Exception {
    ...
    @Test
    public void stage3DeleteAllTxt() throws Exception {
    ...
    @Test
    public void stage3DeleteAllBinary() throws Exception {
    ...
    @Test
    public void stage3SearchTxtByPrefix() throws Exception {
        this.stage3SearchByPrefix(this.getStoreWithTextAdded());
    }

    @Test
    public void stage3SearchBinaryByPrefix() throws Exception {
        this.stage3SearchByPrefix(this.getStoreWithBinaryAdded());
    }

    @Test
    public void stage3DeleteAllWithPrefix() throws Exception {
        DocumentStore store = this.getStoreWithTextAdded();
    ...
    private List<Document> search(DocumentStore store, String keyword, int expectedMatches) throws Exception {
        List<Document> results = store.search(keyword);
    ...
    private void stage3SearchByPrefix(DocumentStore store) throws Exception {
    ...
    //stage 1 tests
    @Test
    public void testPutBinaryDocumentNoPreviousDocAtURI() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
    ...
    @Test
    public void testPutTxtDocumentNoPreviousDocAtURI() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
    ...
    @Test
    public void testPutNewVersionOfDocumentBinary() throws Exception {
    ...
    @Test
    public void testPutNewVersionOfDocumentTxt() throws Exception {
        //put the first version
        DocumentStore store = new DocumentStoreImpl();
        int returned = store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        assertTrue(returned == 0);
    ...
    @Test
    public void testGetTxtDoc() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        int returned = store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        assertTrue(returned == 0);
    ...
    @Test
    public void testGetTxtDocAsBinary() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        int returned = store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
        assertTrue(returned == 0);
    ...
    @Test
    public void testGetBinaryDocAsBinary() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
    ...
    @Test
    public void testGetBinaryDocAsTxt() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        int returned = store.putDocument(new ByteArrayInputStream(this.txt2.getBytes()),this.uri2, DocumentStore.DocumentFormat.BINARY);
        assertTrue(returned == 0);
    ...
    @Test
    public void testDeleteDocReturnValue() throws Exception {
        DocumentStore store = new DocumentStoreImpl();
        store.putDocument(new ByteArrayInputStream(this.txt1.getBytes()),this.uri1, DocumentStore.DocumentFormat.TXT);
