...
public class UndoTest {
    ...
    private DocumentStoreImpl createStoreAndPutOne() throws Exception {
    ...
    private DocumentStoreImpl createStoreAndPutAll() throws Exception {
        DocumentStoreImpl dsi = new DocumentStoreImpl();
        //doc1
    ...
    @Test
    public void stage3PlainUndoThatImpactsMultiple() throws Exception {
    ...
    @Test
    public void stage3UndoByURIThatImpactsOne() throws Exception {
        String keyword1 = "keyword1";
        //step 1: put all documents in
        DocumentStoreImpl dsi = createStoreAndPutAll();
    ...
    @Test
    public void stage3UndoByURIThatImpactsEarlierThanLast() throws Exception {
